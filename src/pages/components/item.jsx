...
export default function Item() {
  return (
    <div className="w-[14rem] h-[25rem] bg-gray-100 flex flex-col p-3 justify-between drop-shadow-md">
      ...
      <button className="h-[12%] bg-green-500 rounded-md p-2 text-white">adicionar ao carrinho</button>
    </div>
  )
}